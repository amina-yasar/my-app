...
import { addMemberAPI } from './api/membersBridge'; // backend API
...
function AdministrationList() {
  ...
  const handleEdit = (member) => { setForm(member); setIsEditing(true); };
  const handleCancel = () => { setForm({ id: null, name: '', email: '', role: '' }); setIsEditing(false); };
  ...
  return (
    <div className="admin-list-container">
      ...
      <form onSubmit={handleSubmit} className="admin-list-form">
        ...
        <div>
          <label>Role: <br />
            <input name="role" value={form.role} onChange={handleChange} type="text" placeholder="Enter role" />
          </label>
        </div>
